...
- Client: The `client` is a HTTP appllication that runs **separate** to the C2, and this can be 'taken with you'. It run's on localhost, allowing you to connect to the remote C2.
