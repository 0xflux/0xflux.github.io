...
The profile comes in the form of a `toml` which must be located in `c2/profiles/*`. I have provided a `profile.example.toml`
file which sets out the required and optional profile fields, which is tracked in git (for this reason you should clone it and 
not use the file I provided in production, as updates will invalidate your profile...). N.b. if you have a better solution, please
get in touch!
...
address = "https://localhost" # required
port = 443 # required
